...
and to send Trx (in units of sun) to a payable address using the ``transfer`` function:
...
Similarly, the supplied Trx value can be controlled too::
    ...
    nameReg.call.value(1 trx)(abi.encodeWithSignature("register(string)", "MyName"));

Lastly, these modifiers can be combined. Their order does not matter::

    nameReg.call.gas(1000000).value(1 trx)(abi.encodeWithSignature("register(string)", "MyName"));
