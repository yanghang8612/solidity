...
If you are new to the concept of smart contracts we recommend you start with :ref:`an example smart contract <simple-smart-contract>` written
in Solidity, followed by :ref:`the basics of blockchains <blockchain-basics>`
and details of the :ref:`Ethereum Virtual Machine <the-ethereum-virtual-machine>`.

When you are ready for more detail, we recommend you read the :doc:`"Solidity in Depth" <solidity-in-depth>` and :doc:`"Solidity by Example" <solidity-by-example>` sections to learn the core concepts of the language.

Smart contracts and blockchains have their own unique issues to watch out for,
so before deploying your contract, make sure you read the
...
.. warning::
    ...
    best-practices when writing your smart contracts, this includes code
    review, testing, audits, and correctness proofs.
