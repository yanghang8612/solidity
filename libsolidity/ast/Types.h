...
public:
	...
	virtual TypeResult unaryOperatorResult(Token::Value) const { return TypePointer(); }
...
public:
	...
	virtual TypeResult unaryOperatorResult(Token::Value _operator) const override;
